...
public class SearchController {
    ...
    public ResponseEntity<ApiResponseDTO<PagedResponse<SearchResponseDTO>>> search(
    ...
    public ResponseEntity<ApiResponseDTO<List<String>>> autocomplete(
            @RequestParam
        ...
        return ResponseEntity.ok(ApiResponseDTO.success(suggestions));
    }
}